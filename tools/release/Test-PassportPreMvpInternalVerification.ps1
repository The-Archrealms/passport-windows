...
$requirements = @(
    ...
    New-Requirement -Id "production_mvp_outstanding_work_report" -Description "Operators can generate a concise redacted report of remaining ProductionMvp closeout, readiness, provisioning, and release-evidence blockers." -CheckIds @("production_mvp_outstanding_work_report_validation") -Checks $checks -Evidence "Outstanding-work report validation uses synthetic fixtures to verify blocker grouping, operator actions, secret-free JSON/Markdown output, summary counts, Markdown coverage, and command paths against real release scripts."
