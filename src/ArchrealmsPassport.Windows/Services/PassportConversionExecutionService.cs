    ...
    public sealed class PassportConversionExecutionService
    {
            ...
            string walletPublicKeyPath)
        {
            ...
            var unsignedRecord = new Dictionary<string, object?>
            {
                ...
                ["quote_record_path"] = ToWorkspaceRelativePath(workspaceRoot, quoteValidation.QuotePath),
                ["quote_record_sha256"] = quoteValidation.QuoteSha256,
                ...
                ["source_ledger_event_sha256"] = sourceEvent.EventHashSha256,
                ...
                ["destination_ledger_event_sha256"] = destinationEvent.EventHashSha256,
